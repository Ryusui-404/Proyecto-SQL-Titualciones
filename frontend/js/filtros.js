async function configurarFiltros() {
    ...
    // Añadir listeners para filtros dinámicos
...
async function configurarFormulario() {
    ...
    // Lógica de selectores dependientes (carrera depende de facultad)
    ...
    modalidadSelect.addEventListener('change', async (e) => {
        ...
        if (noRequiereProyecto.includes(nombreModalidad)) {
            ...
            if (esDiplomado) {
                proyectoNombre.style.display = 'none'; // Opcional, puede tener nombre
